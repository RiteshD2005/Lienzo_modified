...
function ProductMockup({
  ...
  return (
    <div className="relative w-[400px] h-[500px] rounded-lg shadow-lg overflow-hidden">
      ...
      {/* Design Overlay */}
      {image && (
        <Draggable onDrag={onDrag} position={position} bounds="parent">
          <div
          ...
          >
            ...
            />
            <div className="absolute top-0 right-0 bg-black bg-opacity-50 p-1 rounded">
